...
<html>
    ...
    <body>
        ...
        <div id="show-accountCategory" class="content scaffold-show" role="main">
            ...
            <f:display bean="accountCategory" />
            <g:form resource="${this.accountCategory}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.accountCategory}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
