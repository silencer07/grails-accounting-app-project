...
class TransactionDocumentTemp {
    ...
    static mapping = {
        ...
        version false
        id type: 'long', sqlType: 'serial', generator:'sequence', params:[sequence:'transaction_document_temp_id_seq']
        documentNumber type: 'long', sqlType: 'serial', generator:'sequence', params:[sequence:'transaction_document_temp_document_number_seq']
        reference type: 'text'
